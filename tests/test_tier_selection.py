...
async def test_register_glossary_tier_alone():
    """Tier 9 must stand up with no other tier registered.

    The glossary tools read /catalog as well as /glossary — the term<->asset
    link lives in the catalog — so this is the tier most likely to have grown a
